  ...
  return (
    <div className="app">
      ...
      <section className="social">
        <a href="https://www.linkedin.com/in/adammaatouk/" target="_blank" rel="noopener noreferrer" className="social__link">
        ...
        <a href="https://discord.com/users/752041096045133834" target="_blank" rel="noopener noreferrer" className="social__link">
          <svg className="social__icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <a href="https://github.com/NeTBionicR" target="_blank" rel="noopener noreferrer" className="social__link">
        ...
        <a href="mailto:adammaatouknb@gmail.com" className="social__link">
          <svg className="social__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
